...
[`@aws-sdk/client-sns`](https://www.npmjs.com/package/@aws-sdk/client-sns/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sns@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6PhVMc2x64BkpaK8FueX3Ikg95ZexT+5cq1S35TFpPC1Ee9UTNrc5Dvto5FZu8dw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sns": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sns@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sns@3.145.0/index.min.mjs": "sha384-6PhVMc2x64BkpaK8FueX3Ikg95ZexT+5cq1S35TFpPC1Ee9UTNrc5Dvto5FZu8dw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sns/blob/refs/tags/3.145.0/LICENSE
```
